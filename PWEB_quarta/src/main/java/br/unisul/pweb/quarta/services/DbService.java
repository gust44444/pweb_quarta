...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Leoncio", "naosei@gmail.com", "2134656753", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("12342346566", "2134564324"));
		
		Endereco en1 = new Endereco(null, "Santa Terezinha", "929", "Apto 234", "Shopping"     , "2134566", cli1, c2);
		Endereco en2 = new Endereco(null, "São Joaquem", "112", "Casa"    , "Não sei", "88735000", cli1, c3);
